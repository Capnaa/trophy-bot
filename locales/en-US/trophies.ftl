...
trophies-guild-hidden = { $hidden ->
    [one] { $hidden } unused trophy is hidden.
   *[other] { $hidden } unused trophies are hidden.
}
trophies-guild-empty = This server has no trophies yet.
trophies-guild-row = { $emoji } { $name }{ $value }
trophies-footer-page = Page { $page } of { $last }
